"""Shadcn-style SVG icon generator with theme-aware colors."""

from PyQt6.QtGui import QIcon, QPixmap, QPainter
from PyQt6.QtSvg import QSvgRenderer
from PyQt6.QtCore import Qt, QByteArray

# Shadcn-style SVG icons (16x16, stroke-based, clean lines)
...
SVG_ICONS = {
  ...
  <path d="M8 7v4M8 5h.01"/>
    ...
    'keyboard': '''<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  <rect x="1" y="4" width="14" height="8" rx="1.5"/>
  <path d="M4 7h1M7.5 7h1M11 7h1M5 10h6"/>
</svg>''',
}
...
def get_nav_icon(item_name: str, theme: str = 'light', size: int = 16) -> QIcon:
    ...
    # Use foreground color for icons
    color = colors['fg']
